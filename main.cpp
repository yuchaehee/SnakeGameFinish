...
// 게임 설명과 함께 시작 테이블을 표시하는 함수
void displayStartTable() {
    system("cls");
    cout << "Welcome to Snake Game!" << endl << endl;
    cout << "Instructions:" << endl;
    cout << "1. 추가 효과를 위해 특별한 아이템을 수집하기:" << endl;
    cout << "- '★' 뱀의 몸을 하나로 길게 하기." << endl;
    cout << "- '◎' 뱀 몸을 자르기." << endl;
    cout << "- '♣' 뱀의 몸을 더 2개 글리기." << endl;
    cout << "- '§' 뱀 방향을 반대쪽으로 변경하기." << endl << endl;
    cout << "2. 화살표 키를 사용하여 뱀을 조종하기." << endl;
    cout << "3. 게이트를 통과하여 지름길로 이용하기." << endl;
    cout << "4. 몸의 길이가 3보다 작아지면 'Game over'" << endl << endl;
...
int main() {
    // Display the start table with game explanation
    displayStartTable();
